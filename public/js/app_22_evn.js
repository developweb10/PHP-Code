...
$(".useselect").on("click",function(){alert("welcome here");})


function open_select(elem) {
	$(".useselect").trigger("click");
	console.log("clicked");
	...
	/*$if (document.createEvent) {
		...
		console.log(elem[0].dispatchEvent(e));
...
$(document).ready(function () {
	...
	jQuery('.sleectText').click(function(e) {
		...
		//console.log($(this).parent('div').find('.select_center_text').html());
