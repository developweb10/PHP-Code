...
// if the above line isn't working for you for some reason, comment it out and uncomment the next line instead, entering in your merchant identifier you created in your apple developer account
 define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.com.my-meter');
...
define('PRODUCTION_CURRENCYCODE', 'CAD');	// https://en.wikipedia.org/wiki/ISO_4217
define('PRODUCTION_COUNTRYCODE', 'CA');		// https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
define('PRODUCTION_DISPLAYNAME', 'My Meter Shop');
