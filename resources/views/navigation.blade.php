<script>
	...
	function openNav() {
		document.getElementById("bs-example-navbar-collapse-1").style.width = "148px";
	}
...
$Ipad = config('is_Ipad');
?>
<?php /*****************************************************  admin navigation for mobile device  ***************************************************************/ ?>
@if (Auth::user() && Auth::user()->role_id == 1 )
    <div class="col-sm-2 col-md-3 col-lg-3">
        <a class="ul_nav navs f_left" href="{{ url('/admin/managecontent') }}">
        	<img src="{{ asset('/images/metercarWhite.png') }}" style='max-height:60px;max-width: 94%;'>
        </a> 
        @if (!$Ipad && $mobile) 
...
<div >
	...
	<div class="">
			...
			@if (!$Ipad) 
                ...
                @if( ($mobile)  )
                	<table style="width:100%;">
                    	<tr>
                        	<td>
                            	<a class="small-link pull-left to-text navbar-toggle" data-toggle="modal" data-target="#termsDialog" data-static="true" data-keyboard="false" href="#" style="display:none;margin-top: 0; margin-bottom: 0;" id="terms-link" ><i class="fa fa-check-square-o" aria-hidden="true"></i> Terms</a>
                            </td>
		...
		<div id="bs-example-navbar-collapse-1" class="@if (Auth::user() && Auth::user()->role_id == 1 ) @if (!$Ipad && $mobile) sidenav @endif admin_menus @else collapse navbar-collapse @endif">
			...
			<div id = "navbar"> <!--  class=" navbar-collapse" -->
					...
					@if ( Auth::guest() ) 
						@if ( (($Ipad) || (!$mobile)) || ((!$Ipad) && (!$mobile)) ) 
							<?php $target = "#openParkingMeterModal"; ?>
                          @else
                            <?php $target = ""; ?>
                         @endif
                        ...
                        @if (($mobile)) <?php /* (!$Ipad) &&  */ ?>
							<li> 
                                ...
                                @if ( ((!$Ipad) && ($mobile)) ) 
	                            	<div class="meter_icon_position">
                                @endif
                                	<a class="small-link f_right" data-toggle="modal" data-target="<?php echo $target; ?>" href="{{ url('') }}"> Meter</a>
                                    <i class="fa fa-tachometer home-meter f_right"></i>
                                 @if ( ((!$Ipad) && ($mobile)) ) 
	                                </div>
                                @endif
                        ...
                        @else
                        	...
                        	<!--<li><i class="fa fa-tachometer home-meter"></i><a class="small-link f_left_desktop" data-toggle="modal" data-target="<?php echo $target; ?>" href=""> Meter</a></li>-->
                        @endif
...
<!--
	                    ...
	                    <li class="hidden-xs hidden-sm"><a href="#" class="small-link" data-toggle="modal" data-target="#openLoginModal" data-static="true" data-keyboard="false" ><?php /*?><i class="fa fa-sign-in"></i> <?php */?>Login</a></li>
	                  ...
	                  <!--  <li><a href="#" class="small-link sign_up_button" data-toggle="modal" data-target="#openSignUpModal" data-static="true" data-keyboard="false" ><?php /*?><i class="fa fa-sign-in"></i> <?php */?>Sign Up</a></li>-->
                        ...
                        <li id="order_park_sign"><a href="#" class="small-link sign_up_button" data-toggle="modal" data-target="#newLotModal" data-static="true" data-keyboard="false" ><?php /*?><i class="fa fa-sign-in"></i> <?php */?>Order Parking Signs</a></li>
                        
                        <li class="hidden-md hidden-lg"><a href="#" class="small-link" data-toggle="modal" data-target="#openLoginModal" data-static="true" data-keyboard="false" ><?php /*?><i class="fa fa-sign-in"></i> <?php */?>Login</a></li>
...
<?php /*?>
					@if (Auth::user() && Auth::user()->role_id == 1 ) 
						...
						<li class="li-logo"><a href="{{ url('/admin/managecontent') }}"><img src="{{ asset('/images/gray-logo.png') }}" style='max-height:60px;max-width: 100%;'></a></li><!--{{ url('/admin/dashboard') }}-->
                        <li><a href="{{ url('/admin/managecontent') }}">Content Manager</a></li> 

						<!-- <li><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>  -->
                        
                        <li><a href="{{ url('/admin/internal') }}">Internal</a></li>
                        ...
                        <!--<li><a href="{{ url('/admin/companies') }}">Towing</a></li>-->

						<li><a href="{{ url('/admin/settings') }}">Settings</a></li><?php */?>
					...
					@if (Auth::user() && Auth::user()->role_id == 1 )
                        ...
                        @endif
						<!--<li class="li-logo"><a class="ul_nav navs" href="{{ url('/admin/managecontent') }}"><img src="{{ asset('/images/metercarWhite.png') }}" style='max-height:60px;max-width: 94%;'></a></li>{{ url('/admin/dashboard') }}-->
                        <li><a class="ul_nav" href="{{ url('/admin/managecontent') }}"><img src="{{ asset('/images/nav_images/Content Manager.png') }}" /></a></li> 

						<!-- <li><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>  -->
                        
                        <li><a class="ul_nav" href="{{ url('/admin/internal') }}"><img src="{{ asset('/images/nav_images/Internal.png') }}" /></a></li>

						<li><a class="ul_nav" href="{{ url('/admin/users') }}"><img src="{{ asset('/images/nav_images/Users.png') }}" /></a></li> 

						<li><a class="ul_nav" href="{{ url('/admin/reports') }}"><img src="{{ asset('/images/nav_images/Reports.png') }}" /></a></li> 

						<li><a class="ul_nav" href="{{ url('/admin/payments') }}"><img src="{{ asset('/images/nav_images/Payments.png') }}" /></a></li> 
                        
                        <li><a class="ul_nav" href="{{ url('/admin/orders') }}"><img src="{{ asset('/images/nav_images/Orders.png') }}" /></a></li>
                        
                        <!--<li><a href="{{ url('/admin/companies') }}">Towing</a></li>-->

						<li><a class="ul_nav" href="{{ url('/admin/settings') }}"><img src="{{ asset('/images/nav_images/Settings.png') }}" /></a></li>
					...
					@elseif (Auth::user() && Auth::user()->role_id == 2 ) 
						<?php /* Sales Associate*/ ?>
						@if ((!$Ipad) && $mobile)
                            <li><a href="{{ url('/sa-home') }}"><img src="{{ asset('/images/mobile_logo.png') }}" style='max-height:120px;max-width: 100%;'></a></li>
                        @else    
					...
					@elseif (Auth::user() && Auth::user()->role_id == 3 )
						@if ((!$Ipad) && $mobile)
                            <li><a href="{{ url('/') }}"><img src="{{ asset('/images/mobile_logo.png') }}" style='max-height:120px;max-width: 100%;'></a></li>
                        @else    
                            <li><a href="{{ url('/') }}"><img src="{{ asset('/images/gray-logo.png') }}" style='max-height:60px;max-width: 100%;'></a></li>
						@endif
				...
				<ul class="nav navbar-nav right_pull pull-right">
					...
					@else
                      ...
                      <?php /*?>  <li><a href="{{ url('/account/logout') }}" class="logout-link"><i class="fa fa-sign-out"></i> Logout</a></li><?php */?>

						<li><a href="{{ url('/account/logout') }}" class="logout-link admin_logout ul_nav"><img src="{{ asset('/images/nav_images/Logout.png') }}" /></a></li>
...
<?php //echo "Is mobile ? ".$mobile; exit(); ?>
@if((!$mobile && Request::path() != "sample-meter") || ($Ipad))
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<p style="text-align:center; margin:0;"><img src="{{ asset('images/metercar.png') }}" style="max-height:100px; float:none;" > </p>
...
//exit;
//$error_messages = array(); $error_messages = old('messages'); ?>
@if(old('messages'))
    <div class="alert alert-danger meter_message to-text ">
        @foreach( old('messages', array()) as $message)
            <span>
...
@endif 
<?php //if(isset($meter)) { echo "<pre>"; print_r($meter); echo "</pre>"; exit(); } ?>
<form class="form-horizontal fdsfds" role="form" method="POST" action="{{ url('/home/pay') }}" id="customer_pay_form">
...
@if(Auth::user())
	...
	<style type="text/css">
		...
		body:not(.welcome) .navbar-nav > li:not(.li-logo) > a.logout-link{     font-size: 18px;   color: red !important; /*display:none;*/ }
		
		body:not(.admin) .navbar-nav > li:not(.li-logo) > a.logout-link{ display:none;}
...
<style>
	...
	@if(old('messages'))
		<script>
			...
			jQuery('#openParkingMeterModal').modal('show');
			});
		</script>
	@endif
